...
AgoraClrLibrary::AgoraClrChannel::AgoraClrChannel(IChannel* channel) :
	channel(channel),
...
AgoraClrLibrary::AgoraClrChannel::~AgoraClrChannel()
{
	channel->release();
...
int AgoraClrLibrary::AgoraClrChannel::joinChannel(String^ token, String^ info, uid_t uid, ClrChannelMediaOptions^ options)
{
	return channel->joinChannel(MarshalString(token).c_str(), MarshalString(info).c_str(), uid, options);
}

int AgoraClrLibrary::AgoraClrChannel::joinChannelWithUserAccount(String^ token, String^ account, ClrChannelMediaOptions^ options)
{
	return channel->joinChannelWithUserAccount(MarshalString(token).c_str(), MarshalString(account).c_str(), options);
}

int AgoraClrLibrary::AgoraClrChannel::leaveChannel()
{
	channel->registerPacketObserver(nullptr);
	return channel->leaveChannel();
}

int AgoraClrLibrary::AgoraClrChannel::publish()
{
	return channel->publish();
}

int AgoraClrLibrary::AgoraClrChannel::unpublish()
{
	return channel->unpublish();
}

String^ AgoraClrLibrary::AgoraClrChannel::channelId()
{
	return gcnew String(channel->channelId());
}

int AgoraClrLibrary::AgoraClrChannel::getCallId(String^% callid)
{
...
int AgoraClrLibrary::AgoraClrChannel::renewToken(String^ token)
{
	return channel->renewToken(MarshalString(token).c_str());
}

int AgoraClrLibrary::AgoraClrChannel::setEncryptionSecret(String^ secret)
{
	channel->registerPacketObserver(packetObserver);
	return channel->setEncryptionSecret(MarshalString(secret).c_str());
}

int AgoraClrLibrary::AgoraClrChannel::setEncryptionMode(String^ mode)
{
	return channel->setEncryptionMode(MarshalString(mode).c_str());
}

int AgoraClrLibrary::AgoraClrChannel::setClientRole(EnumClientRoleType type)
{
	return channel->setClientRole(static_cast<CLIENT_ROLE_TYPE>(type));
}

int AgoraClrLibrary::AgoraClrChannel::setRemoteVoicePosition(int uid, double pan, double gain)
{
	return channel->setRemoteVoicePosition(uid, pan, gain);
}

int AgoraClrLibrary::AgoraClrChannel::setRemoteRenderMode(uid_t uid, EnumRenderModeType renderMode, EnumVideoMirrorModeType mirrorMode)
{
...
int AgoraClrLibrary::AgoraClrChannel::setDefaultMuteAllRemoteAudioStreams(bool mute)
{
	return channel->setDefaultMuteAllRemoteAudioStreams(mute);
}

int AgoraClrLibrary::AgoraClrChannel::setDefaultMuteAllRemoteVideoStreams(bool mute)
{
	return channel->setDefaultMuteAllRemoteVideoStreams(mute);
}

int AgoraClrLibrary::AgoraClrChannel::muteAllRemoteAudioStreams(bool mute)
{
	return channel->muteAllRemoteAudioStreams(mute);
}

int AgoraClrLibrary::AgoraClrChannel::adjustUserPlaybackSignalVolume(uid_t uid, int volume)
{
	return channel->adjustUserPlaybackSignalVolume(uid, volume);
}

int AgoraClrLibrary::AgoraClrChannel::muteRemoteAudioStream(uid_t uid, bool mute)
{
	return channel->muteRemoteAudioStream(uid, mute);
}

int AgoraClrLibrary::AgoraClrChannel::muteAllRemoteVideoStreams(bool mute)
{
	return channel->muteAllRemoteVideoStreams(mute);
}

int AgoraClrLibrary::AgoraClrChannel::muteRemoteVideoStream(uid_t uid, bool mute)
{
	return channel->muteRemoteVideoStream(uid, mute);
}

int AgoraClrLibrary::AgoraClrChannel::setRemoteVideoStreamType(uid_t uid, EnumRemoteVideoStreamType type)
{
	return channel->setRemoteVideoStreamType(uid,
		static_cast<REMOTE_VIDEO_STREAM_TYPE>(type));
}

int AgoraClrLibrary::AgoraClrChannel::setRemoteDefaultVideoStreamType(EnumRemoteVideoStreamType type)
{
...
int AgoraClrLibrary::AgoraClrChannel::createDataStream(int% streamId, bool reliable, bool ordered)
{
	int id;
...
int AgoraClrLibrary::AgoraClrChannel::sendStreamMessage(int streamId, String^ msg)
{
	std::string data = MarshalString(msg);
	return channel->sendStreamMessage(streamId, data.c_str(), data.size());
}

int AgoraClrLibrary::AgoraClrChannel::addPublishStreamUrl(String^ url, bool transcodingEnabled)
{
	return channel->addPublishStreamUrl(MarshalString(url).c_str(), transcodingEnabled);
}

int AgoraClrLibrary::AgoraClrChannel::removePublishStreamUrl(String^ url)
{
	return channel->removePublishStreamUrl(MarshalString(url).c_str());
}

int AgoraClrLibrary::AgoraClrChannel::setLiveTranscoding(ClrLiveTranscoding^ transcoding)
{
	return channel->setLiveTranscoding(transcoding);
}

int AgoraClrLibrary::AgoraClrChannel::addInjectStreamUrl(String^ url, ClrInjectStreamConfig^ config)
{
	return channel->addInjectStreamUrl(MarshalString(url).c_str(), config);
}

int AgoraClrLibrary::AgoraClrChannel::removeInjectStreamUrl(String^ url)
{
	return channel->removeInjectStreamUrl(MarshalString(url).c_str());
}

int AgoraClrLibrary::AgoraClrChannel::startChannelMediaRelay(ClrChannelMediaRelayConfiguration^ config)
{
	return channel->startChannelMediaRelay(config);
}

int AgoraClrLibrary::AgoraClrChannel::updateChannelMediaRelay(ClrChannelMediaRelayConfiguration^ config)
{
	return channel->updateChannelMediaRelay(config);
}

int AgoraClrLibrary::AgoraClrChannel::stopChannelMediaRelay()
{
	return channel->stopChannelMediaRelay();
}

void AgoraClrLibrary::AgoraClrChannel::bindEventHandler()
{
...
void AgoraClrLibrary::AgoraClrChannel::bindMetaObserver()
{
...
void AgoraClrLibrary::AgoraClrChannel::bindPacketObserver()
{
...
void AgoraClrLibrary::AgoraClrChannel::NativeOnChannelWarning(IChannel* channel, int warn, const char* msg)
{
	if (onChannelWarning) onChannelWarning(this, warn, gcnew String(msg));
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnChannelError(IChannel* channel, int err, const char* msg)
{
	if (onChannelError) onChannelError(this, err, gcnew String(msg));
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnJoinChannelSuccess(IChannel* channel, uid_t uid, int elapsed)
{
	if (onJoinChannelSuccess) onJoinChannelSuccess(this, uid, elapsed);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnRejoinChanelSuccess(IChannel* channel, uid_t uid, int elapsed)
{
	if (onRejoinChannelSuccess) onRejoinChannelSuccess(this, uid, elapsed);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnLeaveChannel(IChannel* channel, const RtcStats& stats)
{
	if (onLeaveChannel) onLeaveChannel(this, gcnew ClrRtcStats(stats));
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnClientRoleChanged(IChannel* channel, CLIENT_ROLE_TYPE old, CLIENT_ROLE_TYPE newer)
{
	if (onClientRoleChanged) onClientRoleChanged(this, static_cast<EnumClientRoleType>(old), static_cast<EnumClientRoleType>(newer));
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnUserJoined(IChannel* channel, uid_t uid, int elapsed)
{
	if (onUserJoined) onUserJoined(this, uid, elapsed);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnUserOffline(IChannel* channel, uid_t uid, USER_OFFLINE_REASON_TYPE reason)
{
	if (onUserOffline) onUserOffline(this, uid, static_cast<EnumUserOfflineReasonType>(reason));
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnConnectionLost(IChannel* channel)
{
	if (onConnectionLost) onConnectionLost(this);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnRequestToken(IChannel* channel)
{
	if (onRequestToken) onRequestToken(this);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnTokenPrivilegeWillExpire(IChannel* channel, const char* token)
{
	if (onTokenPrivilegeWilExpire) onTokenPrivilegeWilExpire(this, gcnew String(token));
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnRtcStats(IChannel* channel, const RtcStats& stats)
{
	if (onRtcStats) onRtcStats(this, gcnew ClrRtcStats(stats));
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnNetworkQuality(IChannel* channel, uid_t uid, int txQuality, int rxQuality)
{
	if (onNetworkQuality) onNetworkQuality(this, uid, txQuality, rxQuality);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnRemoteVideoStats(IChannel* channel, const RemoteVideoStats& stats)
{
	if (onRemoteVideoStats) onRemoteVideoStats(this, gcnew ClrRemoteVideoStats(stats));
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnRemoteAudioStats(IChannel* channel, const RemoteAudioStats& stats)
{
	if (onRemoteAudioStats) onRemoteAudioStats(this, gcnew ClrRemoteAudioStats(stats));
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnRemoteAudioStateChanged(IChannel* channel, uid_t uid, REMOTE_AUDIO_STATE state, REMOTE_AUDIO_STATE_REASON reason, int elapsed)
{
...
void AgoraClrLibrary::AgoraClrChannel::NativeOnActiveSpeaker(IChannel* channel, uid_t uid)
{
	if (onActiveSpeaker) onActiveSpeaker(this, uid);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnVideoSizeChanged(IChannel* channel, uid_t uid, int width, int height, int rotation)
{
	if (onVideoSizeChanged) onVideoSizeChanged(this, uid, width, height, rotation);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnRemoteVideoStateChanged(IChannel* channel, uid_t uid, REMOTE_VIDEO_STATE state, REMOTE_VIDEO_STATE_REASON reason, int elapsed)
{
...
void AgoraClrLibrary::AgoraClrChannel::NativeOnStreamMessage(IChannel* channel, uid_t uid, int streamId, const char* data, size_t length)
{
...
void AgoraClrLibrary::AgoraClrChannel::NativeOnStreamMessageError(IChannel* channel, uid_t uid, int streamId, int code, int missed, int cached)
{
	if (onStreamMessageError) onStreamMessageError(this, uid, streamId, code, missed, cached);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnChannelMediaRelayStateChanged(IChannel* channel, CHANNEL_MEDIA_RELAY_STATE state, CHANNEL_MEDIA_RELAY_ERROR code)
{
...
void AgoraClrLibrary::AgoraClrChannel::NativeOnChannelMediaRelayEvent(IChannel* channel, CHANNEL_MEDIA_RELAY_EVENT code)
{
...
void AgoraClrLibrary::AgoraClrChannel::NativeOnRtmpStreamingStateChanged(IChannel* channel, const char* url, RTMP_STREAM_PUBLISH_STATE state, RTMP_STREAM_PUBLISH_ERROR code)
{
...
void AgoraClrLibrary::AgoraClrChannel::NativeOnTranscodingUpdated(IChannel* channel)
{
	if (onTranscodingUpdated) onTranscodingUpdated(this);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnStreamInjectedStatus(IChannel* channel, const char* url, uid_t uid, int status)
{
	if (onStreamInjectedStatus)
		onStreamInjectedStatus(this, gcnew String(url), uid, status);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnRemoteSubscribeFallbackToAudioOnly(IChannel* channel, uid_t uid, bool isFallbackOrRecover)
{
	if (onRemoteSubscribeFallbackToAudioOnly)
		onRemoteSubscribeFallbackToAudioOnly(this, uid, isFallbackOrRecover);
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnConnectionStateChanged(IChannel* channel, CONNECTION_STATE_TYPE state, CONNECTION_CHANGED_REASON_TYPE reason)
{
...
int AgoraClrLibrary::AgoraClrChannel::NativeGetMaxMetadataSize()
{
	return 1024;
}

bool AgoraClrLibrary::AgoraClrChannel::NativeOnReadyToSendMetadata(IMetadataObserver::Metadata& metadata)
{
	return onReadyToSendMetadata ? onReadyToSendMetadata(gcnew ClrMetadata(metadata)) : false;
}

void AgoraClrLibrary::AgoraClrChannel::NativeOnMetadataReceived(const IMetadataObserver::Metadata& metadata)
{
	if (onMetadataReceived)
		onMetadataReceived(gcnew ClrMetadata(metadata));
}

bool AgoraClrLibrary::AgoraClrChannel::NativeOnSendAudioPacket(agora::rtc::IPacketObserver::Packet& packet)
{
	bool result = true;
...
bool AgoraClrLibrary::AgoraClrChannel::NativeOnSendVideoPacket(agora::rtc::IPacketObserver::Packet& packet)
{
	bool result = true;
...
bool AgoraClrLibrary::AgoraClrChannel::NativeOnReceiveAudioPacket(agora::rtc::IPacketObserver::Packet& packet)
{
	bool result = true;
	if (onSendVideoPacket)
	{
...
bool AgoraClrLibrary::AgoraClrChannel::NativeOnReceiveVideoPacket(agora::rtc::IPacketObserver::Packet& packet)
{
	bool result = true;
	if (onSendVideoPacket)
	{
