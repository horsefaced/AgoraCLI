...
namespace AgoraClrLibrary {
	...
	typedef void(__stdcall * PFOnInviteAcceptedByPeer)(char const * channelID, size_t channelID_size, char const * account, size_t account_size, uint32_t uid, char const * extra, size_t extra_size);
	typedef void(__stdcall * PFOnInviteRefusedByPeer)(char const * channelID, size_t channelID_size, char const * account, size_t account_size, uint32_t uid, char const * extra, size_t extra_size);
	typedef void(__stdcall * PFOnInviteFailed)(char const * channelID, size_t channelID_size, char const * account, size_t account_size, uint32_t uid, int ecode, char const * extra, size_t extra_size);
	typedef void(__stdcall * PFOnInviteEndByPeer)(char const * channelID, size_t channelID_size, char const * account, size_t account_size, uint32_t uid, char const * extra, size_t extra_size);
	...
	delegate void NativeOnInviteAcceptedByPeerDelegate(char const * channelID, size_t channelID_size, char const * account, size_t account_size, uint32_t uid, char const * extra, size_t extra_size);
	delegate void NativeOnInviteRefusedByPeerDelegate(char const * channelID, size_t channelID_size, char const * account, size_t account_size, uint32_t uid, char const * extra, size_t extra_size);
	delegate void NativeOnInviteFailedDelegate(char const * channelID, size_t channelID_size, char const * account, size_t account_size, uint32_t uid, int ecode, char const * extra, size_t extra_size);
	delegate void NativeOnInviteEndByPeerDelegate(char const * channelID, size_t channelID_size, char const * account, size_t account_size, uint32_t uid, char const * extra, size_t extra_size);
